...
@section('content')
<div class="mb-4">
    <h3 class="text-lg font-semibold">Paylaşılan Medya</h3>
</div>
...
<div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden cursor-pointer hover:shadow-lg transition-shadow"
         onclick="window.location='{{ route('parent.media.show', $item->id) }}'">
        @if($item->type === 'image')
    ...
    <div class="col-span-full text-center py-12">
        <p class="text-gray-500">Henüz paylaşılan medya bulunmamaktadır.</p>
    </div>
    @endforelse
</div>
