...
@section('title', 'Aidat Planı Düzenle')
@section('page-title', $feePlan->name . ' - Düzenle')
...
<div class="bg-white rounded-lg shadow p-6">
    <form action="{{ route('admin.fee-plans.update', $feePlan) }}" method="POST">
        @csrf
        @method('PUT')
            ...
            <div>
                <label class="flex items-center">
                    <input type="checkbox" name="is_active" value="1"
                           ...
                           {{ old('is_active', $feePlan->is_active) ? 'checked' : '' }}>
        ...
        <div class="mt-6 flex justify-end space-x-3">
            <a href="{{ route('admin.fee-plans.show', $feePlan) }}" class="bg-gray-300 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-400">
                İptal
            </a>
