...
@section('content')
<div class="mb-4">
    <h3 class="text-lg font-semibold">Tüm Ödemeler</h3>
</div>
    ...
    <table class="min-w-full divide-y divide-gray-200">
        <thead class="bg-gray-50">
            <tr>
                ...
                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Ödeyen</th>
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <a href="{{ route('admin.payments.show', $payment) }}" class="text-indigo-600 hover:text-indigo-900">Görüntüle</a>
                </td>
            </tr>
            @empty
            <tr>
                <td colspan="7" class="px-6 py-4 text-center text-gray-500">Henüz ödeme bulunmamaktadır.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
