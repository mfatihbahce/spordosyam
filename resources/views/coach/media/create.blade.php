...
<div class="bg-white rounded-lg shadow p-6">
    <form action="{{ route('coach.media.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mt-6 flex justify-end space-x-3">
            <a href="{{ route('coach.media.index') }}" class="bg-gray-300 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-400">
                İptal
            </a>
