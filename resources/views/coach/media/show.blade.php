...
<nav class="mb-6 flex items-center space-x-2 text-sm">
    <a href="{{ route('coach.media.index') }}" class="text-indigo-600 hover:text-indigo-800 transition-colors">
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <form action="{{ route('coach.media.destroy', $media->id) }}" method="POST" onsubmit="return confirm('Bu medyayı silmek istediğinize emin misiniz?');">
                @csrf
                @method('DELETE')
